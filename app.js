...
companies.forEach(continentData => {
    const option = document.createElement("option");
    option.value = continentData.continent;
    option.textContent = continentData.continent;
...
select.addEventListener("change", function() {
    switch (select.value) {
        case "Todos":
          ...
          break;
        case companies[0].continent:
            select0();

          break;
          case companies[1].continent:
            select1();
          break;
          case companies[2].continent:
            select2();
          break;
          case companies[3].continent:
            select3();
          break;
          case companies[4].continent:
            select4();
          break;
        default:
          selectAll();
...
function selectAll() {
    ...
    companies.forEach(continent => {
        continent.countries.forEach(country => {
            alf.push({ continent: continent.continent, ...country });
        });
    });

 
    alf.sort((a, b) => a.name.localeCompare(b.name));
    ...
    alf.forEach(country => {
        ...
        cCount.textContent = country.companies.length;


        let cComp = document.createElement("td");
        cComp.textContent = country.companies
            .map(company => Object.keys(company)[0])
            .join(", ");

        tr.appendChild(cName);
        tr.appendChild(cCount);
        tr.appendChild(cComp);
...
function select0() {
    table.innerHTML = "";
    companies[0].countries.forEach(country => {
        let tr = document.createElement("tr");
            let cName = document.createElement("td");
            cName.textContent = country.name;
    
            let countComp = document.createElement("td");
            countComp.textContent = country.companies.length;
    
            let comp = document.createElement("td");
            comp.textContent = country.companies.map(company =>{
                return Object.keys(company)[0];
            }).join(", ");
    
            tr.appendChild(cName);
            tr.appendChild(countComp);
            tr.appendChild(comp);
...
function select1() {
    table.innerHTML = "";
    companies[1].countries.forEach(country => {
        let tr = document.createElement("tr");
            let cName = document.createElement("td");
            cName.textContent = country.name;
...
function select2() {
    table.innerHTML = "";
    companies[2].countries.forEach(country => {
        let tr = document.createElement("tr");
            let cName = document.createElement("td");
            cName.textContent = country.name;
...
function select3() {
    table.innerHTML = "";
    companies[3].countries.forEach(country => {
        let tr = document.createElement("tr");
            let cName = document.createElement("td");
            cName.textContent = country.name;
...
function select4() {
    table.innerHTML = "";
    companies[4].countries.forEach(country => {
        let tr = document.createElement("tr");
            let cName = document.createElement("td");
            cName.textContent = country.name;
